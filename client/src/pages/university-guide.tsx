                  ...
                  <AccordionItem value="ielts">
                    ...
                    <AccordionContent>
                      <ul className="list-disc pl-6 space-y-2">
                        <li>Minimum band score of 6.5-7.5 for most universities</li>
                        <li>Individual section scores of at least 6.0</li>
                        <li>Test must be taken within the last 2 years</li>
                        <li>Academic IELTS required for university admission</li>
                      </ul>
                    </AccordionContent>
                  </AccordionItem>
                  <AccordionItem value="sat">
                    ...
                    <AccordionContent>
                      <ul className="list-disc pl-6 space-y-2">
                        ...
                        <li>Evidence-Based Reading and Writing: 600-750 recommended</li>
                        <li>Consider taking SAT Subject Tests for competitive programs</li>
                      </ul>
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
                    ...
                    {[
                      {
                        ...
                        description: "Identify target schools and programs that match your academic goals and qualifications.",
                      },
                      {
                        title: "Prepare Documents",
                        description: "Gather transcripts, test scores, recommendations, and write your personal statement.",
                      },
                      {
                        title: "Submit Applications",
                        description: "Complete online applications and pay application fees before deadlines.",
                      },
                      {
                        title: "Financial Planning",
                        description: "Research scholarships and prepare financial documentation for visa applications.",
                      },
                    ].map((step, index) => (
